...
```shell
    ...
    $ npm install -g --unsafe-perm sahilchaddha/homebridge-dafang
```
    ...
    "platforms": [
        {
            ...
            "cameras": [{
                ...
                "accessories": [
                    ...
                    "videoConfig": {
                        "source": "-rtsp_transport tcp -i rtsp://192.168.1.2:8554/unicast",
                        "stillImageSource": "-rtsp_transport http -i rtsp://192.168.1.2:8554/unicast -vframes 1 -r 1",
                        "maxStreams": 5,
                        "maxWidth": 1280,
                        "maxHeight": 720,
                        "maxFPS": 25,
