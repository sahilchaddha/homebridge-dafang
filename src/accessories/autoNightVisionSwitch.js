...
const AutoNightVisionSwitch = class extends Accessory {
  ...
  configureMqtt() {
    this.subscribeToMQTT('/night_mode/auto')
  }
  ...
  switchStateChanged(newState, callback) {
    ...
    this.publishToMQTT('/night_mode/auto/set', pubTopic)
    callback()
  }
  ...
  getModelName() {
    return 'Auto Night Vision Switch'
  }

  getSerialNumber() {
    return '00-001-AutoNightVisionSwitch'
  }
}

module.exports = AutoNightVisionSwitch
