...
const MJPEGSwitch = class extends Accessory {
  ...
  configureMqtt() {
    this.subscribeToMQTT('/rtsp_mjpeg_server')
  }
  ...
  switchStateChanged(newState, callback) {
    ...
    this.publishToMQTT('/rtsp_mjpeg_server/set', pubTopic)
    callback()
  }
  ...
  getSerialNumber() {
    return '00-001-MJPEGSwitch'
  }
}

module.exports = MJPEGSwitch
